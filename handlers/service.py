        ...
        try:
            await bot.send_message(
                ...
                text=(
                    ...
                    '1. В функционале "Самопроверка для рабочих" количество вопросов временно изменено с 20-ти на 149, '
                    'чтобы Вы могли проверить свои знания на всем объеме вопросов.\n'
                    '2. Исправлена ошибка при самопроверке. Выдавалось 19 вопросов вместо 20-ти (спасибо Flame7777777!)\n'
                    '3. Об обнаруженых ошибках пишите здесь https://t.me/+3VSYH6qNtKk5NWEy'
                ),
            )
